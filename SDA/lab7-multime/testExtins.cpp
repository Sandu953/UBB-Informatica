...
void testAdauga() {
	...
	//std::cout << vverif[0] << vverif[1] << vverif[2] << vverif[3] << vverif[4] << vverif[5];
...
void testSterge() {
	...
	//for (int i = -100; i <= 100; i=i+2) {  //adaug de 100 de ori valoarea 33
	//	std::cout<<im.element()<<" ";
	//	im.urmator();
	//}
...
void testAllExtins() {
	...
	testCreeaza();
	std::cout << "Test creeaza gata\n";
	testAdauga();
	std::cout << "Test adauga gata\n";
	testIterator();
	std::cout << "Test iterator gata\n";
	testSterge();
	std::cout << "Test sterge gata\n";
	testQuantity();
	std::cout << "Test cantitate gata\n";
